      ...
      merge  into FAWDBTCORE.stg_mobile_events DBT_INTERNAL_DEST
          using o$pt_stg_mobile_events095223694137 DBT_INTERNAL_SOURCE
          on (
        ...
        when matched then
          ...
          DBT_INTERNAL_DEST.SESSION_ID = DBT_INTERNAL_SOURCE.SESSION_ID, 
          DBT_INTERNAL_DEST.SCREEN_RESOLUTION = DBT_INTERNAL_SOURCE.SCREEN_RESOLUTION
          when not matched then
          insert(EVENT_ID, EVENT_TYPE, EVENT_TIMESTAMP, USER_ID, APP_NAME, OPERATING_SYSTEM, COUNTRY, DURATION_SECONDS, CONVERSION_STATUS, CREATED_AT, SESSION_ID, SCREEN_RESOLUTION)
          values(
            ...
            DBT_INTERNAL_SOURCE.SESSION_ID, 
            DBT_INTERNAL_SOURCE.SCREEN_RESOLUTION
            )
