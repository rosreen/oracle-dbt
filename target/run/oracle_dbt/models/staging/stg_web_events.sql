      ...
      merge  into FAWDBTCORE.stg_web_events DBT_INTERNAL_DEST
          using o$pt_stg_web_events120242328578 DBT_INTERNAL_SOURCE
          on (
        ...
        when matched then
          ...
          insert(EVENT_ID, EVENT_TYPE, EVENT_TIMESTAMP, USER_ID, PAGE_URL, BROWSER, DEVICE_TYPE, COUNTRY, DURATION_SECONDS, CONVERSION_STATUS)
          values(
