      ...
      merge  into FAWDBTCORE.stg_web_events DBT_INTERNAL_DEST
          using o$pt_stg_web_events104025605389 DBT_INTERNAL_SOURCE
          on (
        ...
        when matched then
          ...
          DBT_INTERNAL_DEST.PAGE_TITLE = DBT_INTERNAL_SOURCE.PAGE_TITLE
          when not matched then
          insert(EVENT_ID, EVENT_TYPE, EVENT_TIMESTAMP, USER_ID, PAGE_URL, BROWSER, DEVICE_TYPE, COUNTRY, DURATION_SECONDS, CONVERSION_STATUS, CREATED_AT, SESSION_ID, PAGE_TITLE)
          values(
            ...
            DBT_INTERNAL_SOURCE.PAGE_TITLE
            )
